...
published:
created: 2026-06-17
description: "Create and edit automations from the Home Assistant user interface. The visual editor walks you through choosing a trigger, conditions, and actions, no codin..."
tags:
  - "clippings"
---
...
4. On the right side of the trigger, condition, or action row, select the three dots menu and then select **Add note**.
