...
tags:
  - "clippings"
---
Automations support [templating](https://www.home-assistant.io/docs/templating/) in the same way as scripts do. In addition to the [Home Assistant template extensions](https://www.home-assistant.io/docs/templating/) available to scripts, the `trigger` and `this` template variables are available for automations.
...
These are the properties available for an [MQTT trigger](https://www.home-assistant.io/docs/automation/trigger/#mqtt-trigger).
